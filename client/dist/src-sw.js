  ...
  (s.n = (e) => {
    ...
    (() => {
      ...
      (0, s(796).precacheAndRoute)([
        {
          revision: "67b8d2f23b35e3045e4bcb9a9bf32bf0",
        ...
        {
          revision: "75f7353d76f61c87e523fe912af11b72",
        ...
        {
          revision: "1167bbc7025e6ba7782e07cdd203c96e",
        ...
        { revision: "c615cfa3ad815c34f478d48dadbef573", url: "main.bundle.js" },
        {
          revision: "4e0e34f265fae8f33b01b27ae29d9d6f",
      ...
      a({ urls: ["/index.html", "/"], strategy: o }),
        ...
        r(function (e) {
          ...
          plugins: [
            new i({ statuses: [0, 200] }),
            new c({ maxEntries: 30, maxAgeSeconds: 2592e3 }),
          ],
        }));
    })();
})();
